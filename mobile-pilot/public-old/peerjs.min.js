(() => {
  ...
  class s {
    ...
    unpack_uint64() {
      let e = this.read(8),
        t = ((((((256 * e[0] + e[1]) * 256 + e[2]) * 256 + e[3]) * 256 + e[4]) * 256 + e[5]) * 256 +
              e[6]) * 256 + e[7];
  ...
  function f() {
    'object' != typeof window || c || 'undefined' == typeof console ||
      'function' != typeof console.log || console.log.apply(console, arguments);
  }
  function m(e, t) {
    ...
    let r = function (e) {
      ...
      i = function (e, i) {
        ...
        if (e && 'object' == typeof e.video) {
          ...
          if (
            o &&
            ('user' === o.exact || 'environment' === o.exact || 'user' === o.ideal ||
              'environment' === o.ideal) &&
  ...
  function F(e) {
    if (
      'object' == typeof e && e.RTCPeerConnection &&
      ...
      'object' == typeof e && e.RTCPeerConnection &&
      'getSenders' in e.RTCPeerConnection.prototype &&
      'createDTMFSender' in e.RTCPeerConnection.prototype && e.RTCRtpSender &&
      ...
      e.RTCPeerConnection.prototype.getSenders = function () {
        ...
        Object.defineProperty(e.RTCRtpSender.prototype, 'dtmf', {
          get() {
            return void 0 === this._dtmf && ('audio' === this.track.kind
  ...
  function z(e) {
    ...
    e.RTCPeerConnection.prototype.addTrack = function (e, n) {
      ...
      return this._shimmedLocalStreams[n.id]
  ...
  function $(e, t) {
    ...
    (e.RTCPeerConnection = e.webkitRTCPeerConnection),
      e.RTCPeerConnection && t.version < 53 &&
      ['setLocalDescription', 'setRemoteDescription', 'addIceCandidate'].forEach(function (t) {
        let n = e.RTCPeerConnection.prototype[t];
        e.RTCPeerConnection.prototype[t] = ({
          [t]() {
            return arguments[0] =
              new ('addIceCandidate' === t ? e.RTCIceCandidate : e.RTCSessionDescription)(
                arguments[0],
              ),
              n.apply(this, arguments);
          },
    ...
    if (
      ...
      if (
        n.mediaDevices.getUserMedia = function (n) {
          return 'object' == typeof n && 'object' == typeof n.audio &&
      ...
      if (r && r.prototype.applyConstraints) {
        ...
        r.prototype.applyConstraints = function (n) {
          return 'audio' === this.kind && 'object' == typeof n &&
  ...
  function W(e, t) {
    e.navigator.mediaDevices && 'getDisplayMedia' in e.navigator.mediaDevices ||
      !e.navigator.mediaDevices || (e.navigator.mediaDevices.getDisplayMedia = function (n) {
        if (!(n && n.video)) {
        ...
        return !0 === n.video ? n.video = { mediaSource: t } : n.video.mediaSource = t,
  ...
  function q(e) {
    !e.RTCPeerConnection || 'removeStream' in e.RTCPeerConnection.prototype ||
      (e.RTCPeerConnection.prototype.removeStream = function (e) {
  ...
  function et(e) {
    ...
    e.RTCPeerConnection.prototype.createOffer = function () {
      return this.setParametersPromises && this.setParametersPromises.length
        ? Promise.all(this.setParametersPromises).then(() => t.apply(this, arguments)).finally(
          () => {
            this.setParametersPromises = [];
          },
        )
  ...
  function ea(e) {
    ...
    !t.getUserMedia && t.mediaDevices && t.mediaDevices.getUserMedia &&
      ...
      if (e) {
        ...
        !1 === e.offerToReceiveAudio && t
          ? 'sendrecv' === t.direction
            ? t.setDirection ? t.setDirection('sendonly') : t.direction = 'sendonly'
        ...
        !1 === e.offerToReceiveVideo && n
          ? 'sendrecv' === n.direction
            ? n.setDirection ? n.setDirection('sendonly') : n.direction = 'sendonly'
  ...
  function eg(e) {
    ...
    e.RTCIceCandidate = function (e) {
      if (
        'object' == typeof e && e.candidate && 0 === e.candidate.indexOf('a=') &&
        ((e = JSON.parse(JSON.stringify(e))).candidate = e.candidate.substring(2)),
          e.candidate && e.candidate.length
      ) {
        let r = new n(e), i = t(ef).parseCandidate(e.candidate);
  ...
  function ey(e) {
    !e.RTCIceCandidate || e.RTCIceCandidate && 'relayProtocol' in e.RTCIceCandidate.prototype ||
      d(e, 'icecandidate', (e) => {
        if (e.candidate) {
  ...
  function e_(e, n) {
    ...
    let r = function (e) {
      ...
      o = function (e) {
        let t = 65536;
        return 'firefox' === n.browser &&
          (t = n.version < 57
            ? -1 === e ? 16384 : 2147483637
            : n.version < 60
            ? 57 === n.version ? 65535 : 65536
            : 2147483637),
          t;
      },
      s = function (e, r) {
  ...
  function eb(e) {
    ...
    Object.defineProperty(t, 'connectionState', {
      get() {
        return ({ completed: 'connected', checking: 'connecting' })[this.iceConnectionState] ||
  ...
  function ev(e, t) {
    if (
      !e.RTCPeerConnection || 'chrome' === t.browser && t.version >= 71 ||
  ...
  function ek(e, t) {
    ...
    n && 0 !== n.length && (e.RTCPeerConnection.prototype.addIceCandidate = function () {
      return arguments[0]
        ? ('chrome' === t.browser && t.version < 78 || 'firefox' === t.browser && t.version < 68 ||
            'safari' === t.browser) && arguments[0] && '' === arguments[0].candidate
          ? Promise.resolve()
          : n.apply(this, arguments)
  ...
  function eT(e, t) {
    ...
    n && 0 !== n.length && (e.RTCPeerConnection.prototype.setLocalDescription = function () {
      ...
      return e.sdp || 'offer' !== e.type && 'answer' !== e.type
        ? n.apply(this, [e])
        : ('offer' === e.type ? this.createOffer : this.createAnswer).apply(this).then((e) =>
          n.apply(this, [e])
        );
    });
  }
  em.generateIdentifier = function () {
    ...
    em.writeCandidate = function (e) {
      ...
      return t.push('typ'),
        t.push(r),
        'host' !== r && e.relatedAddress && e.relatedPort &&
    ...
    em.writeExtmap = function (e) {
      return 'a=extmap:' + (e.id || e.preferredId) +
        (e.direction && 'sendrecv' !== e.direction ? '/' + e.direction : '') + ' ' + e.uri +
    ...
    em.writeCryptoLine = function (e) {
      return 'a=crypto:' + e.tag + ' ' + e.cryptoSuite + ' ' +
        ('object' == typeof e.keyParams ? em.writeCryptoKeyParams(e.keyParams) : e.keyParams) +
    ...
    em.writeCryptoKeyParams = function (e) {
      return e.keyMethod + ':' + e.keySalt + (e.lifeTime ? '|' + e.lifeTime : '') +
    ...
    em.getIceParameters = function (e, t) {
      let n = em.matchPrefix(e + t, 'a=ice-ufrag:')[0], r = em.matchPrefix(e + t, 'a=ice-pwd:')[0];
    ...
    em.parseRtpParameters = function (e) {
      ...
      for (let r = 3; r < n.length; r++) {
        let i = n[r], o = em.matchPrefix(e, 'a=rtpmap:' + i + ' ')[0];
        if (o) {
          let n = em.parseRtpMap(o), r = em.matchPrefix(e, 'a=fmtp:' + i + ' ');
          switch (
            n.parameters = r.length ? em.parseFmtp(r[0]) : {},
              n.rtcpFeedback = em.matchPrefix(e, 'a=rtcp-fb:' + i + ' ').map(em.parseRtcpFb),
              t.codecs.push(n),
              n.name.toUpperCase()
          ) {
            case 'RED':
    ...
    em.writeRtpDescription = function (e, t) {
      let n = '';
      n += 'm=' + e + ' ' + (t.codecs.length > 0 ? '9' : '0') + ' ' +
        (t.profile || 'UDP/TLS/RTP/SAVPF') + ' ' + t.codecs.map((e) =>
    ...
    em.parseRtpEncodingParameters = function (e) {
      ...
      let n = [],
        ...
        s = em.matchPrefix(e, 'a=ssrc:').map((e) => em.parseSsrcMedia(e)).filter((e) =>
          'cname' === e.attribute
        ),
        a = s.length > 0 && s[0].ssrc,
        c = em.matchPrefix(e, 'a=ssrc-group:FID').map((e) =>
          e.substring(17).split(' ').map((e) => parseInt(e, 10))
        );
    ...
    em.parseRtcpParameters = function (e) {
      let t = {},
        n =
          em.matchPrefix(e, 'a=ssrc:').map((e) => em.parseSsrcMedia(e)).filter((e) =>
            'cname' === e.attribute
          )[0];
    ...
    em.parseMsid = function (e) {
      ...
      let r = em.matchPrefix(e, 'a=ssrc:').map((e) => em.parseSsrcMedia(e)).filter((e) =>
        'msid' === e.attribute
      );
    ...
    em.parseSctpDescription = function (e) {
      let t;
      let n = em.parseMLine(e), r = em.matchPrefix(e, 'a=max-message-size:');
    ...
    em.writeSessionBoilerplate = function (e, t, n) {
      return 'v=0\r\no=' + (n || 'thisisadapterortc') + ' ' + (e || em.generateSessionId()) + ' ' +
        (void 0 !== t ? t : 2) + ' IN IP4 127.0.0.1\r\ns=-\r\nt=0 0\r\n';
    },
    ...
    ef = em;
  let eS = function ({ window: e } = {}, t = { shimChrome: !0, shimFirefox: !0, shimSafari: !0 }) {
      let n = function (e) {
          ...
          if (n.userAgentData && n.userAgentData.brands) {
            ...
            if (e) return { browser: 'chrome', version: parseInt(e.version, 10) };
          }
          return n.mozGetUserMedia
            ...
            ? (t.browser = 'safari',
              ...
              t.supportsUnifiedPlan = e.RTCRtpTransceiver &&
    ...
    eP = new class {
      ...
      isUnifiedPlanSupported() {
        let e;
        let t = this.getBrowser(), n = eR.browserDetails.version || 0;
  ...
  function eB(e, t, n, r, i) {
    ...
    var o = new eA(n, r || e, i), s = ej ? ej + t : t;
    return e._events[s]
  ...
  Object.create && (eL.prototype = Object.create(null), new eL().__proto__ || (ej = !1)),
    ...
    eU.prototype.listeners = function (e) {
      var t = ej ? ej + e : e, n = this._events[t];
      if (!n) return [];
      if (n.fn) return [n.fn];
  ...
  class eN extends eM.EventEmitter {
    start(e, t) {
      ...
      !this._socket && this._disconnected &&
        (this._socket = new WebSocket(n + '&version=' + ez.version),
          ...
          this._socket.onopen = () => {
            this._disconnected ||
              (this._sendQueuedMessages(), eI.log('Socket open'), this._scheduleHeartbeat());
          });
    }
    _scheduleHeartbeat() {
    ...
    _cleanup() {
      ...
      (this._socket.onopen = this._socket.onmessage = this._socket.onclose = null,
        this._socket.close(),
        this._socket = void 0), clearTimeout(this._wsPingTimer);
    }
  ...
  class e$ {
    startConnection(e) {
      ...
      if (
        this.connection.peerConnection = t,
          this.connection.type === w.Media && e._stream &&
      ...
      eI.log('Listening for ICE candidates.'),
        ...
        e.oniceconnectionstatechange = () => {
          switch (e.iceConnectionState) {
            case 'failed':
              eI.log('iceConnectionState is failed, closing connections to ' + t),
              ...
              break;
            case 'closed':
              eI.log('iceConnectionState is closed, closing connections to ' + t),
      ...
      try {
        ...
        try {
          ...
          'OperationError: Failed to set local offer sdp: Called in wrong state: kHaveRemoteOffer' !=
              e && (t.emitError(E.WebRTC, e), eI.log('Failed to setLocalDescription, ', e));
        }
      } catch (e) {
    ...
    _addTracksToConnection(e, t) {
      if (eI.log(`add tracks from stream ${e.id} to peer connection`), !t.addTrack) {
        return eI.error("Your browser does't support RTCPeerConnection#addTrack. Ignored.");
      }
  ...
  class eW extends eG {
    ...
    constructor(e, t, n) {
      super(e, t, n),
        ...
        this.connectionId = this.options.connectionId || eW.ID_PREFIX + ex.randomToken(),
  ...
  class eH {
    ...
    async retrieveId() {
      try {
        ...
        let e = '';
        throw '/' === this._options.path && this._options.host !== ex.CLOUD_HOST &&
          (e =
    ...
    async listAllPeers() {
      try {
        ...
        if (200 !== e.status) {
          if (401 === e.status) {
            let e = '';
            throw e = this._options.host === ex.CLOUD_HOST
        ...
        throw eI.error('Error retrieving list peers', e),
  ...
  class eK extends eY {
    ...
    _trySend(e) {
      ...
      try {
        ...
        return eI.error(`DC#:${this.connectionId} Error when sending:`, e),
          this._buffering = !0,
          this.close(),
          !1;
      }
  ...
  class eX extends eK {
    ...
    _handleChunk(e) {
      let t = e.__peerData, n = this._chunkedData[t] || { data: [], count: 0, total: e.total };
      if (
    ...
    _sendChunks(e) {
      ...
      for (let e of (eI.log(`DC#${this.connectionId} Try to send ${t.length} chunks...`), t)) {
        this.send(e, !0);
      }
    }
    constructor(e, t, r) {
  ...
  class eZ extends eJ {
    ...
    _handleMessage(e) {
      ...
      switch (t) {
        ...
        case O.Offer: {
          ...
          if (
            t && (t.close(), eI.warn(`Offer received for existing Connection ID:${e}`)),
              n.type === w.Media
          ) {
            let i = new eW(r, this, { connectionId: e, _payload: n, metadata: n.metadata });
    ...
    reconnect() {
      if (this.disconnected && !this.destroyed) {
        eI.log(`Attempting reconnection to server with ID ${this._lastServerId}`),
          this._disconnected = !1,
    ...
    constructor(e, t) {
      ...
      if (
        super(),
          this._serializers = { raw: eq, json: eQ, binary: eX, 'binary-utf8': eX, default: eX },
          this._id = null,
          ...
          this._options.logFunction && eI.setLogFunction(this._options.logFunction),
      ...
      n
        ? this._initialize(n)
        : this._api.retrieveId().then((e) => this._initialize(e)).catch((e) =>
          this._abort(E.ServerError, e)
        );
    }
  }
  eZ.DEFAULT_KEY = 'peerjs', window.peerjs = { Peer: eZ, util: ex }, window.Peer = eZ;
})();
